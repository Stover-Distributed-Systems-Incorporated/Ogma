...
DATA_DIR="$HOME/.local/share/ogma"
...
printf "\n\033[1mOgma Performance Profile\033[0m\n"
printf "═══════════════════════════════════════════════════════════\n"
printf "  Text: %d chars\n" "${#TEXT}"
printf "═══════════════════════════════════════════════════════════\n\n"
...
TTS_BACKEND=local OGMA_MUTE_CHECKED=1 OGMA_NO_QUEUE_PLAYER=1 PATH="$_STUBS:$PATH" \
...
if $COMPONENTS; then
    ...
    _W=$(mktemp "${TMPDIR:-/tmp/}ogma_prof_XXXXXXXXXX.wav")
    python3 -c "
